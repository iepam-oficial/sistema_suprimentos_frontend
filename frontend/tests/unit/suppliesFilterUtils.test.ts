...
const supplies: Supply[] = [
  makeSupply({ id: '1', name: 'Papel A4', description: 'Resma branca', visible_to_requesters: true, category: { id: 'cat-a', value: 'papel', label: 'Papel' } as Supply['category'] }),
  makeSupply({ id: '2', name: 'Caneta Azul', description: 'Tinta permanente', visible_to_requesters: false, category: { id: 'cat-b', value: 'escrita', label: 'Escrita' } as Supply['category'] }),
