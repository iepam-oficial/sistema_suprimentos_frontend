...
interface DepreciationRatesImportPanelProps {
  onImported: () => void;
  onRateLimited: () => void;
}
...
export function DepreciationRatesImportPanel({
  onImported,
  onRateLimited,
}: DepreciationRatesImportPanelProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <Heading size="md">Importar taxas de depreciação</Heading>
      </CardHeader>
      <CardBody>
        <VStack spacing={4} align="stretch">
          <Text fontSize="sm" color="gray.500">
            Envie um arquivo JSON com as regras de depreciação. O arquivo pode ser um array
            de objetos ou um objeto com o campo <b>rows</b>.
          </Text>
          ...
          <HStack spacing={4} align="flex-start" wrap="wrap">
            <VStack align="stretch" spacing={2}>
              ...
              <Text
                fontSize="xs"
                color={fileError ? 'red.500' : selectedFile ? 'green.600' : 'gray.400'}
                noOfLines={1}
                maxW="280px"
              >
                {fileError ??
