...
export type SubcategoryRefDTO = Pick<SubcategoryDTO, 'id' | 'value' | 'label' | 'category_id' | 'created_at' | 'updated_at'>;
/** @deprecated Use UnitOfMeasureDTO from reference-data */
export type UnitRefDTO = Pick<UnitOfMeasureDTO, 'id' | 'name' | 'symbol' | 'description' | 'created_at' | 'updated_at'>;
