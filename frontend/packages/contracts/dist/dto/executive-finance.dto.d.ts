export declare const PoloMetric: {
    readonly DESPESAS: "DESPESAS";
...
export declare const MoneyTrendDirection: {
    readonly UP: "UP";
    readonly DOWN: "DOWN";
    readonly FLAT: "FLAT";
};
export type MoneyTrendDirection = (typeof MoneyTrendDirection)[keyof typeof MoneyTrendDirection];
export declare const ExecutiveFinanceAlertSeverity: {
    readonly LOW: "LOW";
    readonly MEDIUM: "MEDIUM";
    readonly HIGH: "HIGH";
};
export type ExecutiveFinanceAlertSeverity = (typeof ExecutiveFinanceAlertSeverity)[keyof typeof ExecutiveFinanceAlertSeverity];
...
//# sourceMappingURL=executive-finance.dto.d.ts.map